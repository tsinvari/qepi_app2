    ...
    return new Scaffold(
      ...
      body: new Column(
        children: <Widget>[
                ...
                children: <Widget>[
                  new Row (
                    ...
                    children: <Widget>[
                      ...
                      new IconButton(icon: new Icon(Icons.swap_vertical_circle, color: const Color(0xFF5A5859),), onPressed: (){_selectDate(context);}),
                    ],
                  ),
                      new Row(
                        children: <Widget>[
          ...
          new Text ("COST TO SEND 36.00 €", style: new TextStyle(fontSize: 17.0, fontFamily: "Gibson", color: const Color(0xFF5a5859), fontWeight: FontWeight.bold,),),
          new Container(
